...
func TestKnight(t *testing.T) {
	outputs := []struct {
		...
		{name: "knight-flying-with-gun-1.png", width: hoverFrames, directions: 16},
		{name: "knight-flying-with-gun-1-shadow.png", width: hoverFrames, directions: 16},
		{name: "knight-flying-with-gun-2.png", width: hoverFrames, directions: 2},
		{name: "knight-flying-with-gun-2-shadow.png", width: hoverFrames, directions: 2},
	...
	cases := []struct {
		...
		{name: "save error - flying gun 1", blockSave: "knight-flying-with-gun-1.png"},
		{name: "save error - flying gun shadow 1", blockSave: "knight-flying-with-gun-1-shadow.png"},
		{name: "save error - flying gun 2", blockSave: "knight-flying-with-gun-2.png"},
		{name: "save error - flying gun shadow 2", blockSave: "knight-flying-with-gun-2-shadow.png"},
