...
Per-direction source PNGs live in
`mod/graphics/gopher-{n,ne,e,se,s,sw,w,nw}.png` at 1024 px by 1024 px. Edit
those, then regenerate the derived sheets:
...
`gopher-shadow-*.png`, `gopher-8dir.png`, and
`gopher-running-with-gun.png`. Sprite changes do not hot-reload; exit to
